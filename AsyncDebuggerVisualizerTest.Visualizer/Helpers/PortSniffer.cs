...
{
    // https://www.pinvoke.net/default.aspx/iphlpapi.GetExtendedTcpTable
    public class PortSniffer
    {
        // NOTE: Does not do IPv6 (see https://www.pinvoke.net/default.aspx/iphlpapi.GetExtendedTcpTable
        // for the rest of the definitions)
